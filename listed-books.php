            ...
            <div class="panel-body">
                ...
                <form method="POST" action="" class="my__form">
                    <div class="form-group ">
                        ...
                        <input type="text" name="search" id="search" class="form-control" placeholder="Search by Book Name, Author, or Category" />
                    </div>
                ...
                if ($search != '') {
                    $sql = "SELECT tblbooks.BookName, tblcategory.CategoryName, tblauthors.AuthorName, tblbooks.ISBNNumber, tblbooks.BookPrice, tblbooks.id as bookid, tblbooks.bookImage, tblbooks.isIssued 
                            ...
                            WHERE tblbooks.BookName LIKE :search OR tblauthors.AuthorName LIKE :search OR tblcategory.CategoryName LIKE :search";
